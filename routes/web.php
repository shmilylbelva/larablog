...
Route::group([
	...
	Route::get('article/state/{article}', 'ArticleController@state')->name('admin.article.state');
	...
	Route::get('tag/state/{tag}', 'TagController@state')->name('admin.tag.state');
	...
	Route::get('link/state/{link}', 'LinkController@state')->name('admin.link.state');
	...
	Route::get('page/state/{page}', 'PageController@state')->name('admin.page.state');
	...
	Route::get('user/state/{user}', 'UserController@state')->name('admin.user.state');
	...
	Route::get('node/state/{node}', 'NodeController@state')->name('admin.node.state');
	...
	Route::get('comment/state/{comment}', 'CommentController@state')->name('admin.comment.state');
